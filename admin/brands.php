    ...
    <tbody>
      <?php while ($brand = mysqli_fetch_assoc($results)): ?>
        <tr>
          ...
          <td><?= $brand['brand']; ?></td>
          <td class="text-center"><a href="brands.php?delete=<?= $brand['id']; ?>" class="btn btn-xs btn-default"><span class="glyphicon glyphicon-remove-sign"></span></a></td>
        </tr>
        <?php endWhile; ?>
    </tbody>
  </table>
